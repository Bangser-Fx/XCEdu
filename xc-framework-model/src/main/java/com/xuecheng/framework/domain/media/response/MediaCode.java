...
public enum MediaCode implements ResultCode {
    ...
    UPLOAD_CHUNK_FAIL(false,22006,"上传分片失败！"),
    CHUNK_NOT_FOUND(false,22007,"找不到文件分片！"),
    MERGEFILE_CREAT_FAIL(false,22008,"合并文件创建失败！"),
    MERGE_FILE_MERGEFAIL(false,22008,"合并文件失败！"),
    RABBIT_MSG_SENDFAIL(false,22009,"视屏处理消息发送失败！");
